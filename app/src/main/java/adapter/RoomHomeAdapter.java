...
public class RoomHomeAdapter extends RecyclerView.Adapter<RoomHomeAdapter.ViewHolder>{
    ...
    public RoomHomeAdapter(Context context, List<Room> allRoom) {
    ...
    @NonNull
    @Override
    public RoomHomeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.room_home_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull RoomHomeAdapter.ViewHolder holder, int position) {
